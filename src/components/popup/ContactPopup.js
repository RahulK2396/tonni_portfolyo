...
const ContactPopup = ({ show, close, PortfolioDetails }) => {
              ...
              <div className="mapouter">
                <div className="gmap_canvas">
                  <iframe
                    ...
                    height={375}
                    id="gmap_canvas"
                    src={`https://maps.google.com/maps?q=${encodeURIComponent(PortfolioDetails?.about.address)}&t=&z=13&ie=UTF8&iwloc=&output=embed&phone=${PortfolioDetails?.about.phoneNumber}`}
                    frameBorder={0}
                    scrolling="no"
                    marginHeight={0}
                    marginWidth={0}
